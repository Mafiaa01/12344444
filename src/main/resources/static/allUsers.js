function edit() {
    ...
    fetch('http://localhost:8090/api/edit', {
        method: 'PUT',
        body: JSON.stringify({
            id: id,
            email: email,
...
function getModalDelete(id) {
    ...
    fetch('http://localhost:8090/api/getUserById/' + id)
    ...
    fetch('http://localhost:8090/api/getUserById/' + id)
        ...
        .then(user => {
            ...
            modal.innerHTML =
                ...
                '                               class="form-control form-control-sm" title="Select Roles">' +
...
function newUser() {
    ...
    fetch('http://localhost:8090/api/create', {
        method: 'POST',
        body: JSON.stringify({
            email: email,
            password: password,
...
function showHeader() {
    fetch('http://localhost:8090/api/getUser')
        .then(response => response.json())
        .then(user => {
